const messages = {
  en: {
    ...
    imageQuality: 'Rendering Quality',
    qualityLow: 'Low',
    qualityMedium: 'Medium',
    seed: 'Seed',
    seedRandom: 'Random',
    seedHint: 'Optional integer. Leave blank for a random result.',
    ...
    clear: '✕ Clear',
    addToReferences: 'Add to reference images',
    ...
    modelGrokImagine2Desc: 'xAI\'s latest image generation and editing model via OpenRouter, with 1K–2K output and quality control.',
    modelSeedream50ProDesc: 'ByteDance Seedream 5.0 Pro via OpenRouter. High-fidelity text-to-image and image editing with 1K–2K output.',
  ...
  zh: {
    ...
    fullscreen: '⛶ 全屏',
    clear: '✕ 清除',
    addToReferences: '插入到参考图',
    addedToReferences: '已插入到参考图',
    ...
    modelGrokImagine2Desc: '通过 OpenRouter 使用 xAI 最新的图像生成与编辑模型，支持 1K–2K 输出和质量控制。',
    modelSeedream50ProDesc: '通过 OpenRouter 使用字节跳动 Seedream 5.0 Pro，支持高保真文生图、图像编辑和 1K–2K 输出。',
