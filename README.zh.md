...
- **批量生成** — 一次最多并行生成 9 张图片
- **生成历史** — 自动保存至浏览器 IndexedDB（无条数上限），点击即可恢复之前的生成结果
- **中英双语 UI** — 根据浏览器语言自动检测
- **暗色模式** — 跟随系统 / 浅色 / 深色
...
| 选项 | 可选值 | 备注 |
|---|---|---|
| 宽高比 | 1:1, 2:3, 3:2, 3:4, 4:3, 4:5, 5:4, 9:16, 16:9, 21:9, ... | Flash 额外支持 1:4, 1:8, 4:1, 8:1；Lite 仅支持 10 种标准比例 |
| 图片尺寸 | 512, 1K, 2K, 4K | Pro 最小为 1K；Lite 仅支持 1K |
